...
public class Ocenka {
	...
	System.out.println("Vnesete go maksimalniot broj na bodovi na tekstot");
    ...
    if(bodovi>max) {
	System.out.println("Student gi nadminal standardite, no za zal tolku poeni ne moze da dobil");
	System.exit(0);
	}
    procent=bodovi/max*100;
    if(procent<51){
